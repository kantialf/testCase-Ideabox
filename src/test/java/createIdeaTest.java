...
//    }
    ...
    public void TC_062(){
        ...
        fieldTitle.sendKeys("Tes Membuat ide");
        ...
        fieldProblem.sendKeys("Apakah bisa membuang limbah sayur?");
        ...
        try{
            ...
            if (!actualText2.equals(expectedText2)){
                System.out.println(String.format("[BUG] Alert sukses publish tidak muncul. Teks seharusnya: %s, Teks sebenarnya: %s.", expectedText2, actualText2));
            }
        } catch (Exception e) {
            System.out.print("[BUG] Alert sukses publish tidak muncul");
        }
        ...
        System.out.println(String.format("[BUG] Halaman menampilkan pesan kesalahan: %s", driver.findElement(By.xpath("/html/body/div/div/div/div/h2")).getText()));

        // memastikan data tersimpan di active idea
        driver.get("https://km4.ideaboxapp.com/my-ideas?tab=active");
        ...
        if (!judulBaru.contains("Tes Membuat ide")){
            System.out.println("[BUG] Data baru ide tidak tersimpan ke active idea.");
        }
    }
    ...
    public void TC_063(){
        ...
        WebElement btnPublish2 = driver.findElement(By.xpath("/html/body/div[3]/div/div/div[3]/div/button[2]"));
        btnPublish2.click();
        ...
        String actualUrl = driver.getCurrentUrl();
        String expectedUrl = "https://km4.ideaboxapp.com/home"; // URL yang diharapkan
        if (!actualUrl.contains(expectedUrl)) {
            System.out.println("\\n[BUG] Halaman tidak mengarah ke halaman home. Actual URL: " + actualUrl);
        }
        System.out.println(String.format("[BUG] Halaman menampilkan pesan kesalahan: %s", driver.findElement(By.xpath("/html/body/div/div/div/div/h2")).getText()));
    ...
    public void TC_067() {
        ...
        // title idea
        WebElement fieldTitle = driver.findElement(By.name("desc[0].value"));
        fieldTitle.sendKeys("Membuat ide TC_067");
        ...
        if (fieldName.getText().contains("Veda")){
            System.out.println("[BUG] Member yang belum melengkapi profil bisa dipilih.");
        }

        WebElement modalInvite = driver.findElement(By.xpath("/html/body/div[3]/div/div"));
        if (!modalInvite.getText().contains("Tidak bisa diundang karena belum melengkapi profil.")){
        ...
        if (buttonConfirm.isEnabled()) {
            System.out.println("[BUG] Button Confirm bisa diklik dan tidak disable.");
        }
        driver.quit();
    }
    ...
    public void TC_068(){
        ...
        // title idea
        WebElement fieldTitle = driver.findElement(By.name("desc[0].value"));
        fieldTitle.sendKeys("Membuat ide TC_068");
        ...
        select2.selectByVisibleText("Hipsterrrr");

        WebElement buttonConfirm2 = driver.findElement(By.xpath("/html/body/div[3]/div/div/div[4]/div/button[2]"));
        buttonConfirm2.click();

        WebElement successEditMember = driver.findElement(By.xpath("//div[@class='MuiAlert-message css-1xsto0d']"));
        if (!successEditMember.isDisplayed()){
            System.out.println("[BUG] Alert sukses edit data member tidak muncul.");
        }
    ...
    public void TC_069() {
        ...
        // title idea
        WebElement fieldTitle = driver.findElement(By.name("desc[0].value"));
        fieldTitle.sendKeys("Membuat ide TC_069");
        ...
        //verifikasi alert delete member sukses
        WebElement alertSucDel = driver.findElement(By.xpath("//div[@class='MuiAlert-message css-1xsto0d']"));
        if (!alertSucDel.isDisplayed()){
            System.out.println("[BUG] Alert sukses delete member tidak muncul.");
        }

        //verifikasi member terhapus
        WebElement tabelMemb = driver.findElement(By.xpath("/html/body/div/div/div/div[3]/div[2]/div[2]"));
        if (tabelMemb.getText().contains("ariferdiansyah110@gmail.com")){
            System.out.println("[BUG] Member tidak terhapus pada tabel Team Member.");
        }
    ...
    public void TC_073(){
        ...
        // title idea
        WebElement fieldTitle = driver.findElement(By.name("desc[0].value"));
        fieldTitle.sendKeys("Membuat ide TC_073");
        ...
        WebElement errorMessage = driver.findElement(By.xpath("/html/body/div/div/div/div"));
        if (!currentUrl7.equals(expUrl)) {
            System.out.println(String.format("[BUG] Halaman tidak mengarah ke tab Drafts. Url seharusnya: %s, Url sebenarnya: %s.", expUrl, currentUrl7));
            System.out.println(String.format("[BUG] Pesan kesalahan: %s", errorMessage.getText()));
        }

        // verifikasi apakah data tersimpan
        driver.get("https://km4.ideaboxapp.com/my-ideas?tab=draft");
        wait(2000);
        WebElement fieldDraftIdea = driver.findElement(By.xpath("/html/body/div/div/div/div/div/div[2]/nav/div/div/div[2]/div[2]"));
        String judulBaru = fieldDraftIdea.getText();
        if (!judulBaru.contains("Membuat ide TC_073")){
            System.out.println("[BUG] Ide baru tidak tersimpan ke draft.");
        }
    ...
    public void TC_070(){
        ...
        // title idea
        WebElement fieldTitle = driver.findElement(By.name("desc[0].value"));
        fieldTitle.sendKeys("Membuat ide TC_070");
        ...
        WebElement fieldDraftIdea = driver.findElement(By.xpath("/html/body/div/div/div/div/div/div[2]/nav/div/div/div[2]/div[2]"));
        String judulBaru = fieldDraftIdea.getText();
        if (!judulBaru.contains("Membuat ide TC_070")){
            System.out.println("[BUG] Ide baru tidak tersimpan ke draft.");
        }
    ...
    public void TC_072(){
        ...
        // title idea
        WebElement fieldTitle = driver.findElement(By.name("desc[0].value"));
        fieldTitle.sendKeys("Membuat ide TC_071");
    ...
    public void TC_071(){
        ...
        System.out.println("Hasil Eksekusi TC_071:");
        // title idea
        WebElement fieldTitle = driver.findElement(By.name("desc[0].value"));
        fieldTitle.sendKeys("Membuat ide TC_071");
    ...
    public void TC_065(){
        ...
        // title idea
        WebElement fieldTitle = driver.findElement(By.name("desc[0].value"));
        fieldTitle.sendKeys("Membuat ide TC_065");
        ...
        uploadCover.sendKeys(filePath);
        wait(3000);
        WebElement uploadedImage = driver.findElement(By.xpath("/html/body/div/div/div/div[3]/div[2]/div[3]/div/table/tbody/tr[9]/td[2]/div/div[1]/div/span/img"));
        Assert.assertTrue("Uploaded image is displayed", uploadedImage.isDisplayed());
    ...
    public void TC_066(){
        ...
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("window.scrollBy(0,600)"); // You can adjust the scroll value based on your need

        wait(2000);
        // Idea Cover
        WebElement uploadCover = driver.findElement(By.xpath("/html/body/div/div/div/div[3]/div[2]/div[3]/div/table/tbody/tr[9]/td[2]/div/div[2]/div/input"));
        String filePath = "C:/Users/Kanti Alifa/OneDrive/Gambar/seiji2.9MB.jpg";
        uploadCover.sendKeys(filePath);
        ...
        //verify error message file melebihi batas
        WebElement errorMessage4 = driver.findElement(By.xpath("/html/body/div/div/div/div[3]/div[2]/div[3]/div/span"));
        Assert.assertTrue("[BUG] Error message additional attachment tidak tampil", errorMessage4.isDisplayed());
    ...
    public void TC_075() {
        ...
        //verify error message jenis file tidak sesuai
        wait(2000);
        WebElement errorMessage = driver.findElement(By.xpath("/html/body/div/div/div/div[3]/div[2]/div[3]/div/table/tbody/tr[9]/td[2]/div/div[2]/span"));
        ...
        WebElement buttonNext1 = driver.findElement(By.xpath("/html/body/div/div/div/div[4]/div/div[2]/button[1]"));
        js.executeScript("arguments[0].removeAttribute('disabled')", buttonNext1);
